    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          {/* Timeline Dot */}
          <div className="absolute left-4 md:left-1/2 top-10 w-5 h-5 rounded-full bg-blue-400 border-4 border-black shadow-[0_0_20px_rgba(96,165,250,0.6)] md:-translate-x-1/2 z-20"></div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="pl-12 md:pl-0 md:pr-10">
              ...
              {/* Summary Card */}
              <div className="border border-white/10 rounded-2xl bg-white/[0.03] p-6 mb-6 hover:border-blue-400/30 transition">
              ...
              <div className="space-y-4">
                ...
                {highlights.map((item) => (
                  <div
                    key={item.number}
                    className="flex gap-4 border border-white/10 rounded-xl p-4 bg-white/[0.02] hover:border-blue-400/30 transition"
                  >
                    ...
                    <div>
                      ...
                      <h4 className="text-gray-200 text-sm font-semibold mb-1">
                        {item.title}
                      </h4>
            ...
            <div className="pl-12 md:pl-10">
              ...
              <div className="border border-white/10 rounded-2xl bg-white/[0.03] backdrop-blur-sm p-7 hover:border-blue-400/40 transition-all duration-300">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {technologies.map((technology) => (
                      <span
                        key={technology}
                        className="px-3 py-1.5 rounded-full text-xs bg-blue-400/10 text-blue-300 border border-blue-400/20 hover:bg-blue-400/20 transition"
                      >
                        {technology}
                      </span>
                    ))}
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            {skillsGained.map((skill) => (
              <div
                key={skill}
                className="border border-white/10 rounded-xl p-5 text-center bg-white/[0.03] hover:border-blue-400/40 hover:-translate-y-1 transition-all duration-300"
              >
